#!/usr/bin/env python3
"""
Import REAL guest reviews from original data
"""
import requests
import time
...
# REAL guest reviews from original data - First batch (10 reviews)
real_guest_reviews_batch1 = [
    {
...
def main():
    print("🎯 ECHTER IMPORT: Original Gästebewertungen - Batch 1")
    print("=" * 65)
    print(f"Target: {API_BASE_URL}")
    print(f"Reviews to import: {len(real_guest_reviews_batch1)}")
    ...
    for i, review in enumerate(real_guest_reviews_batch1, 1):
    ...
    print("📊 Import-Zusammenfassung (Batch 1):")
